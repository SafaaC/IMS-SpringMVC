	...
	<section class="form-section">
		<div class="container mt-5 w-50">
			<form action="seller">
				...
				<div class="form-group">
					<label for="sellerContact">Seller Contact</label> <input
						type="text" class="form-control" id="sellerContact"
						name="sellerContact" required>
				</div>
				<div class="form-group">
					<label for="sellerAddress">Seller Address</label> <input style="height: 100px"
						type="text" class="form-control" id="sellerAddress"
						name="sellerAddress" required>
				</div>
